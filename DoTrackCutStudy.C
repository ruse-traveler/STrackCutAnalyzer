...
void DoTrackCutStudy() {
  ...
  hTruthVsTrackPt   = new TH2D("hTruthVsTrackPt",   "Truth vs. Track p_{T}",              nPtBins,   rPtBins[0],   rPtBins[1],   nPtBins, rPtBins[0], rPtBins[1]);
  ...
  TPaveText *txt = new TPaveText(txtXY[0], txtXY[1], txtXY[2], txtXY[3]);
