...
void STrackCutStudy::FillTrackHistogram(const Int_t type, const Double_t recoTrkVars[], const Double_t trueTrkVars[], const Double_t recoPhysVars[], const Double_t truePhysVars[]) {

  return;

}  // end 'FillTrackHistogram(Int_t, Double_t[], Double_t[], Double_t[], Double_t[])'



void STrackCutStudy::FillTruthHistogram(const Int_t type, const Double_t recoTrkVars[], const Double_t trueTrkVars[], const Double_t recoPhysVars[], const Double_t truePhysVars[]) {

  return;

}  // end 'FillTruthHistogram(Int_t, Double_t[], Double_t[], Double_t[], Double_t[])'



void STrackCutStudy::FillPileupHistogram(const Int_t type, const Double_t recoTrkVars[], const Double_t trueTrkVars[], const Double_t recoPhysVars[], const Double_t truePhysVars[]) {

  return;

}  // end 'FillPileupHistogram(Int_t, Double_t[], Double_t[], Double_t[], Double_t[])'
